...
# --- Story Agent ---
# Initialize the story_agent variable
story_agent = None
...
try:
    ...
    # ---------------------------------------------------------
    # We construct the story agent, passing the LLM model to use,
    # descriptive prompt, system instructions, and designating 'story' 
    # as the output key in the execution state dictionary.
    story_agent = Agent(
        model=MODEL,
        name="story_agent",
